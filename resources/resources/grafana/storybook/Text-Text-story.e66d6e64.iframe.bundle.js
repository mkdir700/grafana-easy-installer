"use strict";(self.webpackChunk_grafana_ui=self.webpackChunk_grafana_ui||[]).push([[7257],{"./src/components/Text/Text.story.tsx":function(C,x,s){s.r(x),s.d(x,{Basic:function(){return d},Example:function(){return h},default:function(){return I}});var a=s("../../node_modules/react/index.js"),p=s("./src/utils/storybook/StoryExample.tsx"),E=s("./src/components/Layout/Layout.tsx"),r=s("./src/components/Text/Text.tsx"),e=s("../../node_modules/react/jsx-runtime.js"),u=s("../../node_modules/@mdx-js/react/lib/index.js"),c=s("../../node_modules/@storybook/addon-docs/dist/blocks.mjs"),k=s("./src/components/Link/TextLink.tsx"),A=s("./src/components/Tooltip/Tooltip.tsx");function m(t){const n=Object.assign({h1:"h1",p:"p",hr:"hr",ol:"ol",li:"li",a:"a",h2:"h2",h3:"h3",strong:"strong",ul:"ul",code:"code",pre:"pre",em:"em"},(0,u.RP)(),t.components);return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(c.W8,{title:"MDX|Text",component:r.E}),`
...
`]}),`
`,(0,e.jsxs)(n.li,{children:[`
`,(0,e.jsxs)(n.p,{children:["Do not use the ",(0,e.jsx)(n.code,{children:"code"})," variant for anything other than code snippets."]}),`
`,(0,e.jsx)("br",{}),`
`,(0,e.jsx)("br",{}),`
`]}),`
`]}),`
...
`,(0,e.jsx)(c.lN,{children:(0,e.jsxs)(r.E,{color:"primary",element:"p",children:["If you need more help of how to write in Grafana you can go to our ",(0,e.jsx)(k.Y,{href:"https://grafana.com/docs/writers-toolkit/",external:!0,children:"Writer\u2019s Toolkit"})]})}),`
...
`})}),`
`,(0,e.jsx)(c.lN,{children:(0,e.jsxs)(r.E,{color:"primary",element:"p",children:["And Forrest Gump said: ",(0,e.jsx)(r.E,{italic:!0,children:"Life is like a box of chocolates. You never know what you're gonna get."})]})}),`
`,(0,e.jsx)(n.pre,{children:(0,e.jsx)(n.code,{className:"language-jsx",children:`<Text color="primary" element="p">
...
`]}),`
`,(0,e.jsx)(c.lN,{children:(0,e.jsxs)(r.E,{color:"primary",element:"p",truncate:!0,children:["And Forrest Gump said: ",(0,e.jsx)(r.E,{italic:!0,children:"Life is like a box of chocolates. You never know what you are gonna get."})]})}),`
...
`]}),`
`,(0,e.jsx)(c.lN,{children:(0,e.jsx)(A.m,{content:"This is a example of a span element truncated by its parent container",children:(0,e.jsx)("div",{style:{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:(0,e.jsx)(r.E,{color:"primary",variant:"body",children:"This is a example of a span element truncated by its parent container."})})})}),`
...
`,(0,e.jsx)(c.uY,{of:r.E})]})}function P(t={}){const{wrapper:n}=Object.assign({},(0,u.RP)(),t.components);return n?(0,e.jsx)(n,Object.assign({},t,{children:(0,e.jsx)(m,t)})):m(t)}var O=P,L=Object.defineProperty,S=Object.defineProperties,D=Object.getOwnPropertyDescriptors,j=Object.getOwnPropertySymbols,G=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable,g=(t,n,i)=>n in t?L(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,o=(t,n)=>{for(var i in n||(n={}))G.call(n,i)&&g(t,i,n[i]);if(j)for(var i of j(n))N.call(n,i)&&g(t,i,n[i]);return t},l=(t,n)=>S(t,D(n)),f,y,T,b,v,w;const F={title:"General/Text",component:r.E,parameters:{docs:{page:O}},argTypes:{variant:{control:"select",options:["h1","h2","h3","h4","h5","h6","body","bodySmall","code",void 0]},weight:{control:"select",options:["bold","medium","light","regular",void 0]},color:{control:"select",options:["error","success","warning","info","primary","secondary","disabled","link","maxContrast",void 0]},truncate:{control:"boolean"},italic:{control:"boolean"},textAlignment:{control:"select",options:["inherit","initial","left","right","center","justify",void 0]}},args:{element:"h1",variant:void 0,weight:"light",textAlignment:"left",truncate:!1,italic:!1,color:"primary",children:"This is an example of a Text component"}},h=t=>a.createElement(E.gW,null,a.createElement(p.Q,{name:"Header, paragraph and span"},a.createElement(r.E,l(o({},t),{element:"h1"}),"This is a header"),a.createElement(r.E,l(o({},t),{element:"p"}),"This is a paragraph that contains",a.createElement(r.E,{color:"success",italic:!0}," ","a span element with different color and style"," "),"but is comprised within the same block text")),a.createElement(p.Q,{name:"Paragraph with truncate set to true and wrapping up a span element"},a.createElement(r.E,l(o({},t),{element:"p",truncate:!0}),"This is a paragraph that contains",a.createElement(r.E,{color:"warning",italic:!0}," ","a span element"," "),"but has truncate set to true")));h.parameters={controls:{exclude:["element","variant","weight","textAlignment","truncate","italic","color","children"]}};const d=t=>a.createElement("div",{style:{width:"300px"}},a.createElement(r.E,o({element:t.element,variant:t.variant,weight:t.weight,textAlignment:t.textAlignment},t),t.children));var I=F;h.parameters=l(o({},h.parameters),{docs:l(o({},(f=h.parameters)==null?void 0:f.docs),{source:o({originalSource:`args => {
...
}`},(T=(y=h.parameters)==null?void 0:y.docs)==null?void 0:T.source)})}),d.parameters=l(o({},d.parameters),{docs:l(o({},(b=d.parameters)==null?void 0:b.docs),{source:o({originalSource:`args => {
  return <div style={{
    width: '300px'
  }}>
